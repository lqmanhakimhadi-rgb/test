        ...
        with st.form("create_user_form"):
            ...
            if submitted:
                ...
                if name and email:
                    ...
                    if success:
                        st.success(
                            f"✅ User created successfully! ID: {result.get('user_id')}"
                        )
                        st.rerun()
        ...
        if success and users:
            ...
            if selected_user_display:
                ...
                with col2:
                    ...
                    st.warning(
                        "⚠️ This will delete user and posts"
                    )
...
def posts_page():
    ...
    with tab1:
        ...
        if users_success and users:
            ...
            st.warning(
                "⚠️ No users found. Create user first."
            )
        ...
        if users_success and users:
            ...
            if selected_user_display:
                ...
                if success and posts:
                    ...
                    st.write(
                        f"### Posts by {selected_user_display}"
                    )
